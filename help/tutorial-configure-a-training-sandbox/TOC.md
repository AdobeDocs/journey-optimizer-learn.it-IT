...
+ Passaggio 1: configurare la struttura dati e acquisire i dati {#set-up-data-structure-and-ingest-data}
   + [Configurare la struttura dati (manualmente)](/help/tutorial-configure-a-training-sandbox/manual-data-set-up.md)
   + [Acquisire dati (manualmente)](/help/tutorial-configure-a-training-sandbox/manual-data-ingestion.md)
