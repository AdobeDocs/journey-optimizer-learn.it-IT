...
In questa sezione, puoi impostare i tre eventi necessari per gli esercizi pratici in [Sfide Journey Optimizer](/help/challenges/introduction-and-prerequisites.md).
...
Quando si utilizza questo evento, Journey Optimizer riceve informazioni quando una persona acquista prodotti Luma online.
...
1. Aggiungi il [!UICONTROL Condizione ID evento]: `LumaOnlinePurchase.eventType is commerce.purchases`:
   ...
   1. Il giorno **[!UICONTROL Aggiungi una condizione per l’ID evento]** , trascina e rilascia la `eventType` nell’area di lavoro.
   1. Seleziona `commerce.purchases`.
   1. Seleziona **[!UICONTROL Ok]** nell’area di lavoro.
   1. Seleziona **[!UICONTROL Ok]** sul modale.
...
| [!UICONTROL Campi] | TipoEvento<br>productListItem.quantity<br><b>In Elementi elenco prodotti > Prodotti Luma > _*[!DNL yourOrganizationID]* > Prodotto:</b> <br>Nome<br>Prezzo<br> ProductImageURL<br>ProductURL |
| [!UICONTROL Condizione] | [!DNL LumaWishlistAdd.eventType is commerce.saveForLaters] |
| [!UICONTROL Namespace] | E-mail |
...
| [!UICONTROL Condizione] | LumaProductRestock._`your organization's ID`.inventoryEvent.stockEventType è restock |
