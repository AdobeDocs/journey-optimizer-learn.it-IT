...
# Tutorial sulla personalizzazione delle offerte con dati meteo in tempo reale tramite Web SDK {#personalizing-offers-with-real-time-weather-data}
...
+ [Testare la soluzione](./create-web-page.md)
+ [Tipo di contenuto JSON](./json-content-type.md)
+ [Creazione di un modello di IA per la classificazione](./capturing-offer-interactions-with-web-sdk-ai-model.md)
