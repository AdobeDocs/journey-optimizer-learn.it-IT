...
+ Casi d’uso {#use-cases}
   + [Onboarding del cliente](/help/use-cases/customer-onboarding.md)
...
+ Rapporto e monitoraggio {#report-and-monitor}
   ...
   + [Interattività di reporting](/help/report-and-monitor/adobe-journey-optimizer-reporting-interactivity.md)
