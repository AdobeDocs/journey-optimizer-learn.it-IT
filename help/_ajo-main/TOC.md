...
+ Playbook di casi d’uso {#use-case-playbooks}
   ...
   + [Creare e pubblicare istanze playbook](http://experienceleague.adobe.com/it/docs/platform-learn/tutorials/use-case-playbooks/create-and-publish-a-playbook-instance){target="_blank"}
...
+ Canali {#channels}
   ...
   + Canale di esperienza basata su codice{#code-based-experience-channel}
      ...
      + [Aggiungere campi modulo a modelli di canale esperienza basati su codice](/help/channels/form-fields-in-code-based-experiences.md)
...
+ Gestione dei contenuti{#content-management}
   ...
   + Utilizzare i frammenti {#fragments}
      ...
      + [Aggiungere testo RTF a un frammento modificabile](/help/content-management/add-rich-text-to-editable-fragments.md)
