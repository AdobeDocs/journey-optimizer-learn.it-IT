...
> ![Proprietà campagna](/help/summit/l820-lab-workbook/assets/2-3-1-2-campaign-properties.png)
...
1. Nella sezione del pubblico, fai clic su **[!UICONTROL Seleziona pubblico]**.
   ...
   ![sezione pubblico](/help/summit/l820-lab-workbook/assets/2-3-2-5-audience-section.png)
...
1. Seleziona il pubblico, quindi fai clic su **[!UICONTROL Salva]**.
   ...
   ![selezione pubblico](/help/summit/l820-lab-workbook/assets/2-3-2-7-select-audience.png)
...
#### 4.2.3.2 Modificare il comportamento al clic del messaggio in **aprire una pagina di prodotto**
...
1. Fai clic su **+** accanto a **Nome (attributi profilo>Persona>Nome completo)** per aggiungere il campo di personalizzazione al testo.
   ...
   > 
   >![Token Personalization](/help/summit/l820-lab-workbook/assets/2-3-personalization-token.png)
...
1. Fai clic su **[!UICONTROL Rivedi per attivare]**.
   ...
   ![pulsante di revisione e attivazione](/help/summit/l820-lab-workbook/assets/2-3-4-review-and-activate-button.png)
...
>
> ![stato campagna](/help/summit/l820-lab-workbook/assets/2-3-push-completed.png)
> 
